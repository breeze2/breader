...
function handleSetArticles(
  state: IIArticlesState,
  payload: ISetArticlesPayload
) {
  let lastDateTime = ''
...
function handleSetCurrentArticle(
  state: IIArticlesState,
  payload: ISetCurrentArticlePayload
) {
  return state.set('current', payload.article)
}

function handleSetArticlesFilter(
  state: IIArticlesState,
  payload: ISetArticlesFilterPayload
) {
  return state.set('filter', payload.filter)
}

function handleSetIsFetchingArticle(
  state: IIArticlesState,
  payload: ISetIsFetchingArticlesPayload
) {
  return state.set('isFetching', payload.isFetching)
}

function handleSetIsUpdatingCurrentArticle(
  state: IIArticlesState,
  payload: ISetIsUpdatingCurrentArticlePayload
) {
